...
class Main(wx.Frame):
    def __init__(self, parent, title):
        super(Main, self).__init__(parent, title=title, size=(300, 200))
        ...
        #thisOne = wx.StaticText(panel, label="Combo box", style=wx.ALIGN_CENTRE)

        #box.Add(thisOne, 0, wx.EXPAND | wx.ALIGN_CENTER_HORIZONTAL | wx.ALL, 5)
...
app = wx.App()
Main(None, 'ComboBox and Choice demo')
app.MainLoop()