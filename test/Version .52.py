...
class GUI(wx.Frame):
    ...
    def __init__(self, parent, id, title):
        ...
        panel1 = wx.lib.scrolledpanel.ScrolledPanel(mainPanel, -1, size=(800, 400), pos=(20, 200), style=wx.BORDER_SUNKEN)

        panel2 = wx.lib.scrolledpanel.ScrolledPanel(mainPanel, -1, size=(250, 400), pos=(840, 200), style=wx.SUNKEN_BORDER)
        panel2.SetupScrolling(scroll_y=True, scroll_x=True)
        ...
        for x in range(0, (len(output_list))):
            for i in range(0, (len(output_list))):
                cb = wx.CheckBox(panel2, -1, '', (10 + y1, 10 + y))
                cb.SetValue(False)
