...
class MainFrame(wx.Frame):
    ...
    def addPage(self):
        ...
        official_list1 = wx.ListBox(page, -1, (110, process_height_location), (500, 30),
                                    style=wx.TE_MULTILINE | wx.BORDER)
        wx.Choice(page, -1, (630, process_height_location), (90, 40), choices=sampleList)
        ...
        notes_process = wx.StaticText(page, -1, "Notes About This Process", pos=(15, process_height_location + 195),
                                      size=(100, 0))
